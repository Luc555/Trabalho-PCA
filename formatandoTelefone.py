...
numeroCelular= numeroCelular[:11]

def diminuir(numeroCelular):
    max = 11 # Numero Maximo de caracteres Permitidos.
    if len(numeroCelular) > max:
        return numeroCelular[:max]
    else:
        return numeroCelular

numeroCelular = diminuir(numeroCelular)
print (numeroCelular)
